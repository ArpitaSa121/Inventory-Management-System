...
<body>
	<div class="w3-top" id="Header">
		<div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    		<h3 id="company-title">INVENTORY MANAGEMENT SYSTEM</h3>
  		</div>
	</div>
    ...
    <div id="ContactUs" class="w3-container">
      ...
      <h2 style="margin-left: 50px"> admin@gmail.com</h2>
      <br>
      <br>
      <br>
      <h1 class="w3-text-teal">Call Us at:-</h1>
      <h2 style="margin-left: 50px"> +91783635245</h2>
      <p style="margin-left: 50px">(Available from 9am to 6pm)</p>
    </div>
</body>